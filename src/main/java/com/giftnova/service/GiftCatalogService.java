...
public class GiftCatalogService {
    ...
    private static final List<Map<String, Object>> CATALOG = List.of(
        // $10–$20 range
        gift("gift_01", "Starbucks Gift Card $10",       "Remote Friendly", 10,  "coffee, quick, everyday"),
        gift("gift_02", "Google Play Credit $15",        "Entertainment",   15,  "apps, games, digital"),
        ...
        gift("gift_05", "Grubhub Gift Card $20",         "Remote Friendly", 20,  "food, convenient, flexible"),
        ...
        gift("gift_10", "Netflix Gift Card $30",         "Entertainment",   30,  "streaming, binge, relaxation"),
        gift("gift_11", "DoorDash Gift Card $30",        "Remote Friendly", 30,  "food delivery, local, casual"),
        ...
        gift("gift_15", "DoorDash Gift Card $40",        "Remote Friendly", 40,  "food, convenience, flexible"),
        ...
        gift("gift_18", "Amazon Gift Card $50",          "Remote Friendly", 50,  "versatile, popular, instant delivery"),
        gift("gift_19", "Coursera Plus (1 month)",       "Learning",        50,  "career, certification, professional"),
        gift("gift_20", "Uber Eats Credit $50",          "Remote Friendly", 50,  "food delivery, flexible, team friendly"),
        ...
        gift("gift_24", "Instacart Gift Card $60",       "Remote Friendly", 60,  "groceries, convenience, home"),
        ...
        gift("gift_29", "Patagonia Gift Card $75",       "Lifestyle",       75,  "outdoor, sustainable, premium"),
        gift("gift_30", "Nintendo eShop Card $75",       "Entertainment",   75,  "gaming, casual, family"),
        ...
        gift("gift_36", "Nike Gift Card $100",           "Lifestyle",       100, "fitness, apparel, popular"),
        gift("gift_37", "Logitech MX Keys Mini",         "Tech",            100, "typing, ergonomic, professional"),
        gift("gift_38", "Airbnb Gift Card $100",         "Experience",      100, "travel, stay, weekend getaway"),
        ...
        gift("gift_49", "Marriott Gift Card $150",       "Experience",      150, "hotel, travel, luxury"),
        gift("gift_50", "Lululemon Gift Card $150",      "Lifestyle",       150, "activewear, premium, popular")
    );
